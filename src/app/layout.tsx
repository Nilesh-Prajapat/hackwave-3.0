...
export const metadata: Metadata = {
  title: {
    default: "Hackwave 3.0 | Join the Movement",
    template: "%s | Hackwave 3.0",
  },
  description:
    "Where the boldest builders come to play. Join Hackwave 3.0, the ultimate hackathon experience for innovators, creators, and tech enthusiasts.",
  keywords: [
    "Hackwave 3.0",
    "Hackwave",
    "Hackathon",
  ...
  openGraph: {
    title: "Hackwave 3.0 | Join the Movement",
    description:
      "Where the boldest builders come to play. Join Hackwave 3.0, the ultimate hackathon experience for innovators, creators, and tech enthusiasts.",
    url: "https://hackwave-site.vercel.app/",
    siteName: "Hackwave 3.0",
    // images: [
    //   {
    //     url: "/assets/hackwave title.png",
    //     width: 1200,
    //     height: 630,
    //     alt: "Hackwave 3.0 Hackathon Banner",
    //   },
    // ],
    locale: "en_US",
    type: "website",
