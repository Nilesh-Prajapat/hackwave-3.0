...
const FAQSection = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer: "Venue: Chameli Devi Group of institutions.",
    },
    {
      question: "Who can participate?",
      answer:
        "Students currently enrolled in any course in College can participate in Hackwave 3.0",
    },
    {
      question: "How do I register?",
      answer: (
        <span>
          Submit your Round 1 project on UNSTOP. Follow our social media for
          announcements.
          <br />
          <a
            href={
              "https://unstop.com/hackathons/hackwave-30-chameli-devi-group-of-institutions-1750278"
            }
    ...
    },
    {
      ...
      answer:
        "Yes! Teams can have a minimum of 2 members and a maximum of 5. ",
    },
  ];
        ...
        <div className="text-center mt-12 sm:mt-16 px-2 sm:px-4">
          <div className="bg-[#fcf2e8] text-[#141414] rounded-xl sm:rounded-2xl p-6 sm:p-8 max-w-2xl mx-auto border border-[#141414]/10 sm:mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <a
                href="https://www.instagram.com/hackwavee/"
                target="_blank"
                rel="noopener noreferrer"
